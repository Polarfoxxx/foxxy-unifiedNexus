const postLogIn = require('./CRUD/authentification/post_login');
const postLogOut = require('./CRUD/authentification/post_logout');
const postRegister = require("./CRUD/authentification/post_register");
const postcreateData = require("./CRUD/shared/post_createData");
const getreadData = require("./CRUD/shared/get_readData");
const deleteMessage = require("./CRUD/message/delete_deleteMessage");
const deleteEvent = require("./CRUD/calendarEvent/delete_deleteEvent");
const updateMessageData = require("./CRUD/authentification/put_updateUserData");
const updateUserData = require("./CRUD/authentification/put_updateUserData");
