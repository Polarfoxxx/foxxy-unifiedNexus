...
import { Type_forCloudsGraphProps } from './types';
import { CustomTooltip } from '../Shared';

class CloudsGraph extends PureComponent<Type_forCloudsGraphProps> {
  static demoUrl = 'https://codesandbox.io/p/sandbox/line-chart-width-xaxis-padding-v3w7s9';
  render() {
    const { weatherDataFor_clouds } = this.props;
    ...
    return (
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart
          ...
          {weatherDataFor_clouds.filter((item) => extractTime(item.name) === "0:00:00")
